...
function Nav() {
  ...
  return (
    <div className="flex justify-center items-center fixed top-0 w-full max-w-full p-5 shadow-lg shadow-blue-500 bg-gradient-to-br from-gray-600 via-gray-700 to-gray-800">
      ...
      {/* Logo */}
      <p className="flex w-50 md:justify-end justify-center text-3xl md:text-5xl">JhpDev.</p>

      {/* Menu desplegable (visible en pantallas pequeñas) */}
      <div className={`md:hidden absolute top-full right-0 w-full bg-gray-800 p-5 flex flex-col  gap-4 transition-all duration-800 ${isOpen ? 'flex opacity-100 translate-y-0' : 'hidden opacity-0 translate-y-[-10px]'}`}>
