  ...
  return (
    ...
    >
      <article className="flex flex-col w-full max-w-[95%] justify-center items-center gap-10 shadow-[0_0_25px_5px] shadow-[#3D3027] p-20">
        <h1 className="flex md:w-full w-70 flex-col gap-2 text-5xl font-bold justify-center items-center">
          Experiencia Profesional
        </h1>

        <div className="flex md:w-full w-70 flex-col text-lg gap-5 justify-center items-center">
          ...
          <div className="flex max-w-[95%] md:w-full w-70 md:gap-20 gap-4 justify-center items-center">
            <img
